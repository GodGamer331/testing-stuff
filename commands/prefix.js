exports.run = (client, message) => {
	...
	if(!prefix) return console.shortsend(message.channel, `Try with : \`$$prefix [the prefix you want]\``);
	if(prefix.length > 20) return console.shortsend(message.channel, `Prefix can't contain more than 20 letters.`);
